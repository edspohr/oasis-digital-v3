...
BEGIN
    ...
    IF NEW.email = 'felipe@sumadots.com' THEN
        ...
        IF v_community_org_id IS NOT NULL THEN
            -- We cannot insert into organization_members inside a BEFORE trigger on profiles
            -- easily without potential foreign key races depending on execution order.
            -- Instead, we log this intent and let the AFTER trigger handle the member role.
