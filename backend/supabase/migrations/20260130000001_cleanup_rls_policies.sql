...
-- =============================================================================
-- 7. PROMOTE FELIPE@SUMADOTS.COM AS PLATFORM ADMIN
-- =============================================================================
-- This runs on existing data; if the user doesn't exist yet, it's handled by trigger
UPDATE public.profiles
SET is_platform_admin = TRUE
WHERE email = 'felipe@sumadots.com';

-- Ensure felipe@sumadots.com is owner of oasis-community if they exist
...
WHERE p.email = 'felipe@sumadots.com'
